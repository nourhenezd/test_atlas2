...
const page = { ID: 1, Name: 'Les Ateliers', Color: 'bg-red-800' };
              ...
              >
                ...
                <div className="items-center justify-end text-black">
                  <Listbox value={selectedEntry} onChange={setSelectedEntry}>
                    <Listbox.Button className="inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-1 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500">
                  ...
                  <div className="bg-gray-100 w-full">
                    <div className="relative w-full h-screen p-4 flex flex-col gap-4">
                      ...
                      <div className="relative bg-gray-100 p-4 mt-5 sm:mt-24 md:mt-32 rounded-lg opacity-70">
                        <h1>Atelier de {selectedEntry.Headline}</h1>
                        <h2>
                          Lieu : {selectedEntry.Lieux} - Intervenants :{' '}
                          {selectedEntry.Intervenants.map(
                            (intervenant) => intervenant.Name + ' '
                          )}
                        </h2>
                      </div>
                      <div className="relative bg-gray-100 p-2 md:p-4 rounded-lg overflow-scroll">
                        <div className="w-full md:w-1/2 md:ml-3 mb-2 p-2 md:p-4 bg-white shadow-lg rounded-lg md:float-right">
                          <ImageCarousel images={selectedEntry.Image} />
                        </div>
